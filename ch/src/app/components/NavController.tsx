...
type Props = {
  ...
  havens?: { [k: string]: { id: string; name: string; channels: string[] } };
...
export default function NavController(props: Props) {
  ...
  return (
    <div style={{ position: 'fixed', left: 8, right: 8, bottom: 'calc(8px + env(safe-area-inset-bottom))', height: 64, zIndex: 80, display: 'flex', justifyContent: 'space-between', gap: 8, paddingBottom: 'env(safe-area-inset-bottom)', userSelect: 'none' }}>
      <div style={{ flex: 1, display: 'flex', gap: 8, alignItems: 'center', justifyContent: 'space-around', background: 'linear-gradient(180deg, rgba(7,12,20,0.9), rgba(9,14,24,0.85))', borderRadius: 14, padding: '10px 12px', border: BORDER }}>
        <button
          type="button"
          aria-label="Home"
          title="Home"
          ...
          style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4, padding: '8px 10px', minWidth: 52, minHeight: 44, color: activeNav === 'home' ? COLOR_ACCENT_TEXT : COLOR_TEXT }}
        >
        ...
        <button
          ...
          style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4, padding: '8px 10px', minWidth: 52, minHeight: 44, color: selectedHaven !== '__dms__' ? COLOR_ACCENT_TEXT : COLOR_TEXT }}
        >
        ...
        <button
          ...
          style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4, padding: '8px 10px', minWidth: 52, minHeight: 44, color: activeNav === 'profile' ? COLOR_ACCENT_TEXT : COLOR_TEXT }}
        >
